...
def add_pet():
    ...
    if form.validate_on_submit():
        pet = Pet(nome=form.nome.data,
                  ...
                  foto=form.foto_url.data if form.foto_url.data else None,
...
def edit_pet(pet_id):
    ...
    if form.validate_on_submit():
        ...
        pet.foto = form.foto_url.data if form.foto_url.data else pet.foto # Mantém a URL antiga se o campo vier vazio
